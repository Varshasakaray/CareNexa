...
export const helperAPI = {
  register: (formData) => api.post('/helper/register', formData, {
...
export const patientAPI = {
  ...
  login: (data) => api.post('/patient/login', data),
  verifyEmail: (token) => api.post('/patient/verify', {}, {
    headers: { Authorization: `Bearer ${token}` }
  }),
  getProfile: () => api.get('/patient/profile'),
  logout: () => api.post('/patient/logout'),
};

// Booking API
export const bookingAPI = {
  browseHelpers: (pincode) => api.get('/booking/helpers', { params: { pincode } }),
  ...
  verifyOTP: (bookingId, otp) => api.post(`/booking/${bookingId}/verify-otp`, { otp }),
  cancel: (bookingId, reason) => api.post(`/booking/${bookingId}/cancel`, { reason }),
...
export const adminAPI = {
  ...
  rejectHelper: (helperId, reason) => api.post(`/admin/helpers/${helperId}/reject`, { reason }),
  requestResubmission: (helperId, reason) => api.post(`/admin/helpers/${helperId}/resubmission`, { reason }),
  suspendHelper: (helperId, reason) => api.post(`/admin/helpers/${helperId}/suspend`, { reason }),
