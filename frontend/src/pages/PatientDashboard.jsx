...
import { patientAPI, bookingAPI } from '../lib/api';
...
const PatientDashboard = () => {
  ...
  if (!patient) return <div className="p-8">Failed to load profile</div>;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex justify-between items-center">
          ...
          <Button onClick={() => navigate('/booking/helpers')} variant="outline">
            Browse Helpers
          </Button>
        </div>
      ...
      <Card className="p-6">
        ...
        <p className="text-sm text-gray-500 mt-2">
          Total Bookings: {patient.totalBookings} | Completed: {patient.completedBookings}
        </p>
      </Card>
              ...
              <div key={booking._id} className="border p-4 rounded-lg">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Address: {booking.patientAddress}</p>
                    <p className="text-sm font-semibold mt-2">Total: ₹{booking.totalPrice}</p>
                ...
                {booking.status === 'accepted' && (
                  <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                    <p className="text-sm font-semibold text-blue-800">
                      OTP sent to your email. Please share it with your helper for verification.
                    </p>
                  </div>
                )}
                ...
                {booking.status === 'duty_completed' && !booking.rating && (
                  <div className="mt-4">
                    <p className="text-sm font-semibold mb-2">Rate this helper:</p>
