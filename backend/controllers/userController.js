...
export const registerUser = async (req, res) => {
  try {
    ...
    if (!emailSent) {
      // We still keep the user but inform about the email failure
...
export const verification = async (req, res) => {
  try {
    ...
    // Handle both User and Helper verification
    let account;
    if (decoded.type === "helper") {
      account = await Helper.findById(decoded.id);
    } else {
